...
SECRET_KEY = 'ao8t#+@tjp(6iwik^*ws24d9t^ksbu1+xu)prg0d8&%)d%%4+j'
...
# Uncomment this if you dont want to use docker
from .local import *
...
# Importing JWT Configurations
from backend.configurations.jwt import *
